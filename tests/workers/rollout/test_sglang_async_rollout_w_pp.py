...
def test_async_sglang_rollout_w_pp():
    ...
    fsdp_device_mesh = init_device_mesh("cuda", mesh_shape=(2, 1), mesh_dim_names=("fsdp", "pp"))
    inference_device_mesh_cpu = init_device_mesh("cpu", mesh_shape=(1, tensor_parallel_size, pipeline_parallel_size), mesh_dim_names=("dp", "infer_tp", "pp"))
    ...
    rollout_config = get_rollout_config(max_response_length, max_prompt_length, dtype, tensor_parallel_size, pipeline_parallel_size)
...
if __name__ == "__main__":
    test_async_sglang_rollout_w_pp()
